...
<?php include_once 'snippets/navbar.php' ?>
	...
	<div class="tab-content" id="myTabContent">
		...
		<div class="tab-pane fade" id="ca-projects" role="tabpanel" aria-labelledby="ca-projects-tab">...</div>

		<div class="tab-pane fade" id="ua-projects" role="tabpanel" aria-labelledby="ua-projects-tab">...</div>
