...
(5, '2017-11-10', 'Bank.gov.ua Portal', 'As part of its reform strategy, National Bank of Ukraine requested a new website. The new website needed to be adaptive, based on the principle of open data and include a number of new functions.', 'ua', 'bankgovua-portal', 'project-bankgovua.jpg', ''),
